...
#
# max_id = 2600
# with open('D:\\data\\ZaloAIHackathon\\zai2019_hackaton_train\\annotations\\ninedash_keypoints_train.json') as json_file:
...
def parse_args(args):
    ...
    parser.add_argument('--train-path', help='Path to dataset directory (ie. /tmp/COCO).')
